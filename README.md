...
Usage: hadoop-small-files-merger.jar [options]
  ...
  -b, --blockSize <value>  Specify your clusters blockSize in bytes, 
                           default is set at 131072000 (125MB) which is slightly less than actual 128MB block size. 
                           It is intentionally kept at 125MB to fit the data of the single partition into a block of 128MB. 
                           As spark does not create exact file sizes after partitioning but will always be approximately 
                           equal to the specified block size.
